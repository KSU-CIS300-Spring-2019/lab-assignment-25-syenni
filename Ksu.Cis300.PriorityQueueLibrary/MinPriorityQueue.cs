...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    ...
    {
        /*public MinPriorityQueue(int TPriority, T TValue)
        {
        ...
        /// <summary>
        /// Gets the prority stored in the root of the leftist heap
        /// </summary>
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            {
                if (h1.Data.Key.CompareTo(h2.Data.Key) < 0) //h1 is smaller
                {
        ...
        /// <summary>
        /// Returns and removes the root with the minimum value
        /// </summary>
        /// <returns></returns>
        public TValue RemoveMinimumPriority()
        {
            ...
            {
                TValue results = _elements.Data.Value;
